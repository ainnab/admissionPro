...
.az-column-signup {
  ...
  <?php include 'talum.php';
    ...
    if (mysqli_num_rows($res_u) > 0) {
		...
		$sql = "insert into student (stud_name, stud_ic, password,  modeAds, stud_email,role, app_status, date, app_option) value('".$name."', '".$ic."','".$hashPassword."','NORMAL','".$email."','".$role."','Register','".$dte."','0')";
