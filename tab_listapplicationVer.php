...
<div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <?php while($data = mysqli_fetch_array($records)) { ?>
         <?php $result = mysqli_query($dbconfig,"SELECT * FROM student left join programselection as pg on pg.stud_ic=student.stud_ic where student.role='student' and (student.app_status='Rejected' and student.modeAds='NORMAL') order by pg.stud_ic"); ?>
...
<div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <?php while($data = mysqli_fetch_array($records)) { ?>
         <?php $result = mysqli_query($dbconfig,"SELECT * FROM student left join programselection as pg on pg.stud_ic=student.stud_ic where student.role='student' and (student.app_status='Verified1' and student.modeAds='NORMAL') order by pg.stud_ic"); ?>
            <?php if (mysqli_num_rows($result) > 0) { ?>
