...
$sql3 = "SELECT * FROM program_diploma where mode='DIP' and inst_name='$agent' LIMIT $limitFrom, $limitTill ";
...
?>
 ...
 <hr class="mg-y-30">
        ...
        <button class="btn btn-outline-indigo ">  <a href="professional_dip.php?page=<?=$page-1?>&id=<?php echo $stud_id;?>">Previous</a></button>
<button class="btn btn-outline-indigo"><a href="professional_dip_stud.php?page=<?=$page+1?>&id=<?php echo $stud_id;?>">Next</a></button>
</div>
</div>
