	...
	<div class="page">
		...
		<div class="subpage">
			<div class="div1">
				...
				<p class="p">Ref. Number/No. Ruj:<?php echo substr($stud_id, 0, 6)?> </p>
		...
		<div>
            ...
            <dt class="p" >Matric Number/Nombor Matrik:<?php echo substr($stud_id, 0, 6)?></dt>
        ...
        <div>
                    ...
                    <table  style="width:100%" border="0">
					  ...
					  <tr valign="top">
						...
						<td class="r" width="3%">:</td>
						<td class="r" width="65%"><?php echo date("d M Y",strtotime($new_date));?></td>
					  </tr>
					  <tr valign="top">
					...
					?>
					<table class="table table-bordered mg-b-0" style="width:100%; border-collapse:collapse;" border="1px solid black">
						<tr>
							<td class="r" >&nbsp;<b>Yuran </b></td>
							<td class="r" >&nbsp;<b>Jumlah (RM)</b></td>
					</tr>
					<tr>
						<td class="r" >&nbsp;YURAN PENGAJIAN</td>
						<td class="r" >&nbsp;<?php $feeDaftar; echo number_format(($feeDaftar), 2, '.', ',');?></td>
					</tr>
                    <tr>
						<td class="r" >&nbsp;YURAN PENDAFTARAN</td>
						<td class="r" >&nbsp;<?php  $feeStudy; echo number_format(($feeStudy), 2, '.', ',')?></td>
					</tr>
                    <tr>
						<td class="r" >&nbsp;<b>Jumlah (RM)</b></td>
						<td class="r" >&nbsp;<b><?php  $total =$feeStudy+$feeDaftar; echo number_format(($total), 2, '.', ',') ;?></b></td>
					</tr>
					</table>
					...
					<p class="p" >5.    Sila hubungi Puan Natrah Azira binti Amran di talian 013 - 3369486 untuk sebarang pertanyaan <b>.</b>

					<p class="p">Sekian, terima kasih.</p>
                    </br>
                    <p class="p">Yang Benar,</p>
					<img src="img/sign1.jpg" width="30%">
