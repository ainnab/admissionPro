        ...
        <div class="card card-dashboard-seven">
          <div class="card-body">
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <input id="height" class="form-control" name="height" type="text" value="<?php echo $data['height']; ?>" >
                </div><!-- form group -->
            </div><!-- col -->  
            <div class="col-md-5 col-lg-4">
                <div class="form-group">
                <label class="form-control-label">Weight (kg): <span class="tx-danger"></span></label>
                <input id="weight" class="form-control" name="weight" type="text" value="<?php echo $data['weight']; ?>" >
                </div><!-- form group -->
            </div><!-- col -->  
            </div><!-- row -->
            <div class="row row-sm">
