...
<div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <?php while($data = mysqli_fetch_array($records)) { ?>
         <?php $result = mysqli_query($dbconfig,"SELECT * FROM student left join programselection as pg on pg.stud_ic=student.stud_ic where student.role='student' and (student.app_status='Verified' and student.modeAds='NORMAL') order by pg.stud_ic"); ?>
              ...
              <?php $i=0; $j=1; while($row = mysqli_fetch_array($result)) { ?>
                            ...
                            <td><a href="save.php?id=<?php echo $row['id']?>&verify1=verify1" onClick="return confirm('Are you sure you want to approve this student?')" ><button name="approve"
                                  class="btn btn-primary btn-md">Verify</button>
                                    ...
                                    class="btn btn-danger btn-md">Reject</button></a>
				<a href="save.php?id=<?php echo $row['id']?>&kiv=kiv" onClick="return confirm('Are you sure you want to kiv this application?')" ><button name="kiv"
                                    class="btn btn-warning btn-md">KIV</button></a></td>
...
<div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <?php while($data = mysqli_fetch_array($records)) { ?>
         <?php $result = mysqli_query($dbconfig,"SELECT * FROM student left join programselection as pg on pg.stud_ic=student.stud_ic where student.role='student' and (student.app_status='Verified' and student.modeAds='ROPE') order by pg.stud_ic"); ?>
            <?php if (mysqli_num_rows($result) > 0) { ?>
