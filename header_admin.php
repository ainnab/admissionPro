    ...
    <?php }if ($role == 'finance') { ?>
      ...
      <?php }if ($role == 'hep') { ?>
        ...
        <a href="dashboard_hep.php" class="nav-link"><i class="typcn typcn-clipboard"></i>Dashboard</a>
         <ul class="nav-sub">
        <li class="nav-sub-item <?php echo (basename($_SERVER['PHP_SELF']) == 'tab_listapplicationFinance.php' ?'active' : " ");?>"><a href="tab_listapplicationFinance.php" class="nav-sub-link ">List of Active Students</a></li>
      </ul>
        </li><!-- nav-item -->
      <?php } ?> ?>
      </div><!-- az-sidebar-body -->
