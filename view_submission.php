...
$role = $data['role'];
  ...
  <body class="az-body az-body-sidebar">
    <!-- <div class="az-sidebar">
     ...
     <!--  </div>      <div class="az-sidebar-body">  -->
       <!--  <ul class="nav"> -->
          <!-- <li class="nav-label">Main Menu</li>
          <li class="nav-item active show">
          <a href="main_menu.php" class="nav-link"><i class="typcn typcn-clipboard"></i>Application</a>
          </li>

 <li class="nav-item show">
            <a href="" class="nav-link with-sub"><i class="typcn typcn-clipboard"></i>Program Selection</a>
            <ul class="nav-sub"> -->
            
              <!-- <li class="nav-sub-item "><a href="professional_dip.php" class="nav-sub-link">Professional Diploma</a></li>
              <li class="nav-sub-item "><a href="executive_bachelor.php" class="nav-sub-link">Executive Bachelor</a></li>
              <li class="nav-sub-item"><a href="executive_master.php" class="nav-sub-link">Executive Master</a></li>
