                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="tab">
                                        ...
                                        <button class="tablinks" onclick="openCity(event, 'Personal')"
                                        ...
                                        <button class="tablinks" onclick="openCity(event, 'Work')">Work
                                            Experience</button>
                                                ...
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="firstname" class="form-control" name="firstname"
                                                            ...
                                                            value="<?php echo $data['stud_name']; ?>" type="text"
...
<br>
    <label>Age</label> <input id="age" class="form-control" name="age" type="text" value="<?php echo $age; ?>" readonly>
                                                ...
                                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                                    <div class="form-group">
                                                        <label class="form-control-label">State Of Birth: <span
                                                                class="tx-danger">*</span></label>
                                                ...
                                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Citizenship: <span
                                                                class="tx-danger">*</span></label>
                                                ...
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Ethnic: <span
                                                                class="tx-danger">*</span></label>
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label">About Me <span
                                                                class="tx-danger"></span></label>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <textarea id="mailaddress" class="form-control" name="mailaddress" placeholder="Mailing Address" type="text" required><?php echo $data['address']; ?></textarea>
                </div><!-- form group -->
            </div><!--col-->
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <input id="country" class="form-control" style="text-transform:uppercase" name="country" type="text" value="<?php echo $data['country']; ?>" required>
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Height (cm): <span
                                                                class="tx-danger"></span></label>
                                                ...
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Weight (kg): <span
                                                                class="tx-danger"></span></label>
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">No OKU: <span
                                                                class="tx-danger">if applicable</span></label>
                                                        <input id="nooku" class="form-control" name="nooku" type="text"
                                                            value="<?php echo $data['nooku']; ?>">
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                                <div class="col-lg-8 mg-t-20 mg-lg-t-0">
                                                    <div class="form-group">
                                                        <label class="form-control-label">OKU Type: <span
                                                                class="tx-danger">if applicable</span></label>
                                    ...
                                    <div id="Parent" class="tabcontent">
                                        ...
                                        <form action="save_rk_rope.php" method="post">
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Name of Parent/Guardian: <span
                                                                class="tx-danger"></span></label>
                                                        <input id="namep1" class="form-control"
                                                            style="text-transform:uppercase" name="namep1"
                                                            placeholder="Full Name"
                                                            value="<?php echo $data2['p1_name']; ?>" type="text"
                                                            >
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                            </div><!-- row -->
                                            <div class="row row-sm">
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">IC/Passport Number: <span
                                                                class="tx-danger"></span></label>
                                                        <input id="icp1" class="form-control" name="icp1"
                                                            placeholder="IC Number" type="text"
                                                            value="<?php echo $data2['p1_ic']; ?>">
                                                    </div><!-- form group -->
                                                </div>
                                                <!--col-->
                                            </div><!-- row -->
                                            <div class="row row-sm">
                                                <div class="col-lg-8 mg-t-20 mg-lg-t-0">
                                                    <!-- <div class="form-group">
                                                        <label class="form-control-label">Occupation Status: <span
                                                                class="tx-danger"></span></label>
                                                        <select name="occupationStatus" id="occupationStatus"
                                                            class="form-control select" >
                                                            <option selected disabled="" style="font-size:14px;">Please
                                                                Select</option>
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Name of Parent/Guardian 2:
                                                            <span class="tx-danger"></span></label>
                                                        <input id="namep2" class="form-control"
                                                            style="text-transform:uppercase" name="namep2"
                                                            placeholder="Full Name"
                                                            value="<?php echo $data2['p2_name']; ?>" type="text"
                                                            >
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                            </div><!-- row -->
                                            <div class="row row-sm">
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">IC/Passport Number: <span
                                                                class="tx-danger"></span></label>
                                                        <input id="icp2" class="form-control" name="icp2"
                                                            placeholder="IC Number" type="text"
                                                            value="<?php echo $data2['p2_ic']; ?>">
                                                    </div><!-- form group -->
                                                </div>
                                                <!--col-->
                                            </div><!-- row -->
                                            <div class="row row-sm">
                                                <div class="col-lg-8 mg-t-20 mg-lg-t-0">
                                                    <!-- <div class="form-group">
                                                        <label class="form-control-label">Occupation Status: <span
                                                                class="tx-danger"></span></label>
                                                        <select name="occupationStatus1" id="occupationStatus1"
                                                            class="form-control select" >
                                                            <option selected disabled="" style="font-size:14px;">Please
                                                                Select</option>
                                          ...
                                          echo 'selected';
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Household Income: <span
                                                                class="tx-danger"></span></label>
                                                        <input id="income" class="form-control" name="income"
                                                            placeholder="Eg: RM 5500" type="text"
                                                            value=" <?php echo $data2['income']; ?>">
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Household Number: <span
                                                                class="tx-danger"></span></label>
                                    ...
                                    <div id="Academic" class="tabcontent">
                                        ...
                                        <div class="card card-dashboard-seven">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-rounded btn-warning"
                                                    data-toggle="modal" data-target="#addEdu">
                                                    <i class="fa fa-plus"></i>
                                                    Add
                                                </button>
                                                <div class="modal fade" id="addEdu" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="save_rk_rope.php" method="POST"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>University/Institution/Event/Skill/Provider
                                                                            Name</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" name="fileA"
                                                                            class="form-control">
                                                                        <span class="help-block">*The maximum file size
                                                                            you can upload is 20MB</span>
                                                                    </div>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Type</th>
                                                                    <th>University/Institution/Event/Skill/Provider Name
                                                                    </th>
                                        ...
                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo htmlentities (ucwords($row['edu_type']));?>
                                                                    </td>
                                                                    <td><?php echo htmlentities (ucwords($row['edu_school']));?>
                                                                    </td>
                                                                    <td><?php echo htmlentities (ucwords($row['edu_gred']));?>
                                                                    </td>
                                                                    <td>


                                                                        <a
                                                                            href="edit_academic_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>"><button
                                                                                name="update"
                                                                                class="btn btn-primary btn-md">Edit</button></a>
                                                                        <a href="save_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>&deleteacd=delete"
                   ...
                   ?>
                                    ...
                                    <div id="Work" class="tabcontent">
                                        ...
                                        <div class="card card-dashboard-seven">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-rounded btn-warning"
                                                    data-toggle="modal" data-target="#addWork">
                                                    <i class="fa fa-plus"></i>
                                                    Add
                                                </button>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a
                                                                            href="edit_workexp_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>"><button
                                                                                name="update_new_work"
                                                                                class="btn btn-primary btn-md">Edit</button></a>
                                                                        <a href="save_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>&deletewrk=delete"
                                                                            onClick="return confirm('Are you sure you want to delete?')"><button
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="module-body table">
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a
                                                                            href="edit_upload_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>"><button
                                                                                name="update"
                                                                                class="btn btn-primary btn-md">Edit</button></a>
                                                                        <a href="save_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>&deletedoc=delete"
                                                                            onClick="return confirm('Are you sure you want to delete?')"><button
                                                ...
                                                <div id="Certificate" class="tabcontent">
                                                    ...
                                                    <div class="card card-dashboard-seven">
                                                        <div class="card-body">
                                                        <?php 
                                                         $sql4=mysqli_query($dbconfig,"select * from certificate where stud_ic='$stud_id'");
                                                         while($row=mysqli_fetch_array($sql4))
                                                         {
                                                         ?>
                                                                        <form action="save_rk_rope.php" method="POST"
                                                                            enctype="multipart/form-data">
                                                                            <h5>Please upload certificate from ILMU.</h5>
                                                                                <div class="form-group">
                                                                                    <input type="file"
                                                                                        class="form-control"
                                                                                        id="certDoc" name="certDoc"
                                                                                        required>
                                                                                <a href="folder/rope/<?php echo $row['certDoc']; ?>" target="_blank"><?php echo $row['certDoc']; ?></a>
