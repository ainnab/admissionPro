            ...
            <table id="example1" class="table">
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">STUDENT'S INFO</th>
          ...
          $status = $row1['app_status'];
                  ...
                  <td><?php echo $stud_ic;?></td>
                   <td><?php echo $email;?></td>
                    ...
                    <?php  ?>
                    <td>    <?php if ($status == 'Approved') { ?><a href="offer_letter.php?id=<?php echo $stud_ic; ?>">View</a>  <?php  }else{ }?></td>
                    <td><a href="tab_test.php?id=<?php echo $stud_ic;?>" ><button name="update" class="btn btn-primary btn-md">Edit</button></a></td>
