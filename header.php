      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > PROFESSIONAL DIPLOMA IN OIL AND GAS TECHNOLOGY</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend>OIL AND GAS TECHNOLOGY</legend>
        
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/BUTTON-DEGREE.PNG" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>THE OIL & GAS INDUSTRY STRUCTURE AND OPERATIONS</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
                    </ul>
                </div>
              </div>
        ...
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>OIL & GAS PROCESSING SYSTEMS & PLANT LAYOUT</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <b><div class="title">PROFESSIONAL DIPLOMA IN OIL AND GAS TECHNOLOGY</div></b><br>
        ...
        <span class="font-size-13">PROFESSIONAL DIPLOMA</span></div><br>
                    
        <a href="display.php" class="btn btn-block btn-primary margin-top-40">Enrol Now</a><!-- input type="submit" name="submit" value="Enrol Now" class="btn btn-az-primary btn-block"> -->
      </div>
