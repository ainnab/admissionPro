<?php include 'header_admin.php' ?>
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Finance Dashboard</h2>
        </div>
      ...
      <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card card-dashboard-seven">
         ...
         /* $record1 = mysqli_query($dbconfig,"select COUNT(app_status) AS finance from student where role='student' and (app_status = 'Finance' || app_status = 'Applied'");
           ...
           <div class="row row-sm">
             <div class="col-sm-4 col-lg-4">
               <div class="card card-body">
                 <h6 class="card-title tx-purple tx-20">ROPE Registered Students</h6>
