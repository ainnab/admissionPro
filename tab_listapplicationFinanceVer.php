...
<?php while($data = mysqli_fetch_array($records)) { ?>
      <div class="col-6 col-md-4 col-xl-12">
         <?php $result = mysqli_query($dbconfig,"SELECT * FROM student where role='student' AND (modeAds='ROPE' AND app_status='Finance' || app_status='Verified' || app_status='Submitted' || app_status='Applied');");
         ?>
            ...
            <table id="example1" class="table">
              ...
              <?php $i=0; $j=1; while($row = mysqli_fetch_array($result)) { ?>
                            ...
                            <?php 
                             ...
                             if ($status == 'Finance' || $status='Verified' || $status='Submitted' || $status='Applied') {
                              echo "<td><input type='button' class='btn btn-success' style='border-radius: 15px' value='Paid'></td>";
                            }
                             ?> 
                            </td>
                            </tr>
