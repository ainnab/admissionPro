      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > EXECUTIVE BACHELOR IN ELECTRICAL & ELECTRONICS TECHNOLOGY</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend class="bd-b">ELECTRICAL & ELECTRONICS TECHNOLOGY</legend>

        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/prog.png"  width="460" height="345" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>PRINCIPLES OF ENGINEERING MATHEMATICS</h4>
                    <ul class="post-meta">
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="EXECUTIVE BACHELOR IN ELECTRICAL & ELECTRONICS TECHNOLOGY" hidden>
        <b><div>EXECUTIVE BACHELOR IN ELECTRICAL & ELECTRONICS TECHNOLOGY</div></b><br>
